...
function onDataFromPython(event) {
  ...
  // Update the div with class ".modebar" to display none
  var modebarElement = myPlot.querySelector(".modebar-container");
  console.log(modebarElement)
  if (modebarElement != null) {
    modebarElement.style.setProperty("display", "none", "important");
  }
